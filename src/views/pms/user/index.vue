 <template>
  <CommonPage>
    ...
    <MeModal ref="modalRef" width="520px" :closable="false">
      <n-form
        ref="modalFormRef"
      ...
      >
        ...
        <n-form-item
          ...
          :rule="{
            required: true,
            message: '请输入地区(用,分开多个地区)',
            trigger: ['input', 'blur'],
          }"
        >
          <n-input v-model:value="modalForm.profile.district" />
        </n-form-item>
...
const {
  ...
  name: '用户',
  initForm: { enable: true, profile: {district: ''} },
  doCreate: api.create,
  doDelete: api.delete,
  doUpdate: api.update,
...
const columns = [
  ...
  { title: '地区', key: 'district', width: 150, ellipsis: { tooltip: true } },
  {
    title: '创建时间',
    key: 'createDate',
    width: 180,
      ...
      return [
        ...
        h(
          NButton,
          {
            ...
            onClick: () => handleOpen({ action: 'reset', row, title: '重置密码', onOk: onSave }),
          },
          {
            default: () => '重置密码',
